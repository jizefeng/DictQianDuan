  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="skuList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" @click="handleUpdate(scope.row)" v-hasPermi="['manger:sku:edit']">修改</el-button>
          <el-button link type="primary" @click="handleDelete(scope.row)" v-hasPermi="['manger:sku:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="550px" append-to-body>
      <el-form ref="skuRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品价格" prop="price">
          <el-input-number :min="0.01" :max="999.99" :step="0.5" :precision="2" size="large" v-model="form.price" placeholder="请输入商品价格" />元
        </el-form-item>
