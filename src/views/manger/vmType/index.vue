    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['manger:vmType:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['manger:vmType:export']"
        >导出</el-button>
      </el-col>
...
import { listVmType, getVmType, delVmType, addVmType, updateVmType } from "@/api/manger/vmType";
...
function handleExport() {
  proxy.download('manger/vmType/export', {
    ...queryParams.value
