    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['manger:region:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['manger:region:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="regionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary"  @click="getRegionInfo(scope.row)" v-hasPermi="['manger:region:list']">查看详情</el-button>
          <el-button link type="primary"  @click="handleUpdate(scope.row)" v-hasPermi="['manger:region:edit']">修改</el-button>
          <el-button link type="primary"  @click="handleDelete(scope.row)" v-hasPermi="['manger:region:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<!--    查看详情对话框-->
    <el-dialog title="查看详情" v-model="regionInfoOpen" width="500px" append-to-body>
      <el-form-item label="区域名称" prop="regionName">
...
import { listRegion, getRegion, delRegion, addRegion, updateRegion } from "@/api/manger/region";
...
function handleExport() {
  proxy.download('manger/region/export', {
    ...queryParams.value
